...
namespace CRUD_FebryanEkaS {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Code, string Name, string Price, string Description, byte[] Image) {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public string Code {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Code\' in table \'Employees\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsCodeNull() {
                return this.IsNull(this.tableEmployees.CodeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetCodeNull() {
                this[this.tableEmployees.CodeColumn] = global::System.Convert.DBNull;
            }
...
namespace CRUD_FebryanEkaS.AppDataTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employees` WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `Code` IS NULL) OR (`Code` = ?)) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Description` IS NULL) OR (`Description` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`Code`, `Name`, `Price`, `Description`, `Image`) VALUES " +
                "(?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employees` SET `Code` = ?, `Name` = ?, `Price` = ?, `Description` = ?, `Image` = ? WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `Code` IS NULL) OR (`Code` = ?)) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Description` IS NULL) OR (`Description` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD_FebryanEkaS.Properties.Settings.Default.db_databarangConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Code, Name, Price, Description, [Image] FROM Employees";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_Code, string Original_Name, string Original_Price, string Original_Description) {
        ...
        public virtual int Insert(string Code, string Name, string Price, string Description, byte[] Image) {
            if ((Code == null)) {
        ...
        public virtual int Update(string Code, string Name, string Price, string Description, byte[] Image, int Original_EmployeeID, string Original_Code, string Original_Name, string Original_Price, string Original_Description) {
            if ((Code == null)) {
