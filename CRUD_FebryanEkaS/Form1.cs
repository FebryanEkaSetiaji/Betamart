...
namespace CRUD_FebryanEkaS
{
    public partial class Form1 : Form
    {
            ...
            if (e.KeyChar == (char)13)
            {
                ...
                else
                {
                    var query = from o in this.appData.Employees
                                where o.Code.Contains(txtSearch.Text) || o.Name == txtSearch.Text || o.Price == txtSearch.Text || o.Description.Contains(txtSearch.Text)
                                select o;
        ...
        {
            if (MessageBox.Show("Apakah anda akan menghapus datanya?", "Messagge", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
